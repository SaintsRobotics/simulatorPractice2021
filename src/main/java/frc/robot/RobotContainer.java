...
public class RobotContainer {
  ...
  public Command getAutonomousCommand() {
    ...
    //return new TurnToHeadingCommand(swerveDrivetrain).withRotation(Math.PI/2);
    return new TurnToHeadingCommand(swerveDrivetrain).withRotation(Math.PI/2).andThen(new MoveOneMeterCommand(swerveDrivetrain).withDirection(0)).andThen(new MoveDirectionCommand(swerveDrivetrain).withChangeInX(2).withChangeInY(3));
